def generate(plot_height:int,plot_width:int) -> dict:
    ...
    def draw_furniture(ax, room_name, room):
        ...
        if room_name == "Living":
            ...
            ax.add_patch(Rectangle((room.a2.x - kit_w*0.15-WALL_THICKNESS, room.a3.y+0.6 ), (kit_w*0.15), (room.a2.y - (room.a3.y)-1.2), color='#e2e8f0', ec='#94a3b8', zorder=20))#kitchen edge
            stove_x, stove_y = room.a2.x - kit_w*0.12-WALL_THICKNESS, room.a4.y + (room.a1.y - room.a4.y) / 2 - 1.5
            ...
            b2_w, b2_h = min(mb_w*0.5, 11.0), min(mb_h*0.4, 7.0)
            bx = room.a4.x + 2.0
            by = room.a4.y + 2.5
    ...
    # Doors & Openings
    D_RAD = 2
    draw_opening_v(ax, PLOT_WIDTH - living_w, (PLOT_HEIGHT + (PLOT_HEIGHT - living_h)) / 3.4, 4.0) #living
