def generate(plot_height: int, plot_width: int) -> dict:
    ...
    def draw_furniture(ax, room_name, room):
        ...
        if room_name == "Living":
            ...
            b1_w, b1_h = min(nb_w*0.6, 12.0), min(nb_h*0.6, 8.0)
            bx = room.a4.x + 2.0
            ...
            b2_w, b2_h = min(mb_w*0.6, 12.0), min(mb_h*0.5, 9.0)
            bx = room.a4.x + mb_w*0.2
            ...
            ax.add_patch(Rectangle((bx + 1.0, by + b2_h*0.6), b2_w*0.15, b2_h*0.2, color='white', ec='gray', lw=0.5, zorder=22))
            # Duvet
            ...
            b3_w, b3_h = min(guest_w*0.6, 12.0), min(guest_h*0.4, 10.0)
            bx = room.a4.x + guest_w*0.1
